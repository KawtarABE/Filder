...
import com.example.filder.databinding.ActivityAddAlertWorkerBinding;
...
public class AddAlert_worker extends AppCompatActivity {

    private ActivityAddAlertWorkerBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_alert_worker);
        binding = ActivityAddAlertWorkerBinding.inflate(getLayoutInflater());
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(getApplicationContext(), AllAlerts_worker.class);
    ...
    private void addAlert() {
        ...
        ref.child(""+id).setValue(hashmap).addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void unused) {
                        Toast.makeText(AddAlert_worker.this,"Field successfully added...", Toast.LENGTH_SHORT).show();
                ...
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(AddAlert_worker.this,""+e.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
    }
}